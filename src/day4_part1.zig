...
pub fn main() !void {
    ...
    const expected_sample_answer = 13;
    if (sample_answer != expected_sample_answer) {
        return std.debug.print("Day 4 Part 1 expected sample answer: {d}, got: {d}\n", .{ expected_sample_answer, sample_answer });
    }
    std.debug.print("Day 4 Part 1 sample passed!\n", .{});
    ...
    std.debug.print("Day 4 Part 1 answer: {d}\n", .{answer});
}
